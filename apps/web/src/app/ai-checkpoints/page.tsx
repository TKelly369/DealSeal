...
const STEPS: Step[] = [
  ...
  {
    id: 3,
    title: "Draft Governing Contract (Unsigned)",
    detail: "RISC and related package are assembled as unsigned drafts with estimated pricing until final signature stage.",
    status: "PASS",
  },
  {
    id: 4,
    title: "Pre-First-Green Document Upload Gate",
    detail: "Unsigned collection documents are gathered in the deal jacket before first green can pass.",
    requiredUploads: [
      "Unsigned disclosures",
      "Title application package",
      "Miscellaneous unsigned sales forms",
    ],
    status: "PENDING",
  },
  {
    id: 5,
    title: "First Green Checkpoint (Post-Signature Alignment)",
    detail: "Checkpoint clears after governing RISC is signed and AI confirms all package documents match the governing deal.",
    status: "PENDING",
  },
  {
    id: 6,
    title: "Sign and Upload Governing RISC",
    detail: "Signed contract is uploaded and locked as the authoritative record.",
    status: "PENDING",
  },
  {
    id: 7,
    title: "AI Reconciles Matching Package",
    detail: "System updates dependent docs so disclosures, deal jacket, and funding artifacts all match governing contract terms.",
    status: "PENDING",
  },
  {
    id: 8,
